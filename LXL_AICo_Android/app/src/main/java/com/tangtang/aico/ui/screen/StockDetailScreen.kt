...
import com.tangtang.aico.viewmodel.StockDetailViewModel
 ...
 */
@Composable
private fun PriceCard(uiState: com.tangtang.aico.viewmodel.StockDetailUiState) {
 ...
 */
@Composable
private fun QuoteDetailCard(uiState: com.tangtang.aico.viewmodel.StockDetailUiState) {
    Card(
        modifier = Modifier.fillMaxWidth(),
